...
public class Operaciones {
    ...
    public static void GuardarDisco() {
        try {
            ...
            a.writeBytes(ob.getRfc().toUpperCase() + ":");// Guardaren el archivo, se le pone Write y adelante el tipo de dato
            // de la variable
    ...
    public static void mostrarTodo(File file, boolean showDialog) {
        ...
        try {
            ...
            if (showDialog) JOptionPane.showMessageDialog(new JScrollPane(), acc);
        } catch (Exception e) {
            System.err.print(e);
        }
